...
monoexponential fit for T1-MOLLI inversion recovery
...
def T1_monoexponential(model_parameters, sequence_parameters):
    """ main function for forward signal model fit.
