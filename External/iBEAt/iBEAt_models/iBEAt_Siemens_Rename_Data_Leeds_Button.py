...
def iBEAt_series_name(series): 
    ...
    if ds["SequenceName"] == '*fl3d2':
        ...
        if ds["ImageType"][4] == 'OUT_PHASE': return sequence + '_out_phase'
        if ds["ImageType"][4] == 'IN_PHASE': return sequence + '_in_phase'
        if ds["ImageType"][4] == 'FAT': return sequence + '_fat'
        if ds["ImageType"][4] == 'WATER': return sequence + '_water'
