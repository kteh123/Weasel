...
class ParametricClass(object):
    ...
    def T2Star(self, dicom, imageArray):
        ...
        #dicom.PixelRepresentation = 0 # Force it to be uint - only way for colormap to work
        #dicom.PhotometricInterpretation = 'PALETTE COLOR'
        #dicom.ContentLabel = "HOT_IRON"
        #dicom.ContentDescription = "Hot Iron"
        #print(str(bytearray([255, 0, 16]))) = "bytearray(b'\\xff\\x00\\x10')"
        #dicom.is_implicit_VR = False
        #dicom.RedPaletteColorLookupTableDescriptor = b'\xff\x00\x10' #[256, 0, 8] or [256, 0, 16] or ['256', '0', '8']
        #dicom.GreenPaletteColorLookupTableDescriptor = b'\xff\x00\x10'
        #dicom.BluePaletteColorLookupTableDescriptor = b'\xff\x00\x10'
