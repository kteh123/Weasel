...
def main(weasel):
    ...
    for i, series in list_of_series.enumerate(): # Loop over series and display a progress Bar
        weasel.progress_bar(max=list_of_series.length(), index=i+1, msg="Inverting series {}", title="Invert pixel values ")
